package hieunb.ezy.hieunb.socket.app.test;
...
import hieunb.ezy.hieunb.socket.app.AppEntryLoader;
import hieunb.ezy.hieunb.socket.plugin.PluginEntryLoader;

public class HieunbSocketAppStartupTest {

    private static final String APP_NAME = "hieunb";
    private static final String PLUGIN_NAME = "hieunb";
    private static final String ZONE_NAME = "hieunb";
        ...
        public EzyPluginEntry load() {
            return new PluginEntry() {
                ...
                protected String[] getScanablePackages() {
                    return new String[] { "hieunb.ezy.hieunb" };
                }
            };
        }
    }
